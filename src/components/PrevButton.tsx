...
import arrow from "../assets/dialouge/prev_arrow.png";
import arrow_hover from "../assets/dialouge/prev_arrow_highlighted.png";
...
export function PrevButton({setClick , dialogueCounter}: NextButtonProps){
    ...
    if (dialogueCounter === 1 || dialogueCounter === 0) {
        return (<></>);
    }
